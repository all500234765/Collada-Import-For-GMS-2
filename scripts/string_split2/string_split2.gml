/// string_split2(:string, delimiter:string, real:bool):array<string>
var s = argument[0], d = argument[1], g = argument[2];
...
if (dl) while (p) {
    p -= 1;
    var f = string_copy(s, 1, p);
    ds_list_add(rl, g ? real(f) : f);
